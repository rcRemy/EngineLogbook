...
public class RestoreDialogFragment extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		File backupFile = new File(sd, getString(R.string.filename_backup));
		...
		if (backupFile.exists()) {
			str.append(getString(R.string.dia_file_exist_restore));
			tv.setText(Html.fromHtml(str.toString()));
			final AlertDialog d = new AlertDialog.Builder(getActivity()).setView(v)
					.setTitle(R.string.dia_title_restore).setPositiveButton(R.string.dia_ok, new OnClickListener() {
			...
			str.append(getString(R.string.dia_file_not_exist_restore));
			tv.setText(Html.fromHtml(str.toString()));
			final AlertDialog d = new AlertDialog.Builder(getActivity()).setView(v)
					.setTitle(R.string.dia_title_restore).setPositiveButton(R.string.dia_ok, null).create();
			d.show();
			return d;
		}
	}
