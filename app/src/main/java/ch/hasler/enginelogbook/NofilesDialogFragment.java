...
public class NofilesDialogFragment extends DialogFragment {
	public static NofilesDialogFragment newInstance() {
		NofilesDialogFragment fragment = new NofilesDialogFragment();
		return fragment;
	}
