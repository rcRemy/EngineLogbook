...
public class PscEventActivity extends AppCompatActivity implements
		ActionBar.TabListener {

	private ViewPager mViewPager;
	private PscTabsPagerAdapter mAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAdapter = new PscTabsPagerAdapter(getSupportFragmentManager());
		...
		// adding Tabs
		mTabs = getResources().getStringArray(R.array.pscTabs);
